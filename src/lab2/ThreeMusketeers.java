...
public class ThreeMusketeers {
    ...
    protected void move(final Agent agent) { // TODO
    	...
    	// Adds the move from the agent onto the moves stack, and moves the board
    	
    	Move copy = new Move(agent.getMove());
    	moves.add(copy);
    ...
    private void undoMove() { // TODO
    	...
    	// Gets the move from the top of the moves stack, and moves the board
    	
    	Move move = new Move(moves.get(moves.size() - 1));
